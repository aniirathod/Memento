...
const FlashcardComponent: React.FC<FlashcardProps> = ({
  ...
  return (
    <motion.div
      className={cn("flashcard h-64 w-full max-w-md mx-auto", className)}
      onClick={handleFlip}
    ...
    >
      ...
      >
        ...
        <div
          className={cn(
            "absolute inset-0 flex flex-col justify-center px-6 py-8 rounded-xl dark:bg-purple-700 shadow-md backface-hidden",
        ...
        <div
          className={cn(
            "absolute inset-0 flex flex-col justify-center px-6 py-8 rounded-xl dark:bg-purple-700 shadow-md backface-hidden [transform:rotateY(180deg)]",
            isFlipped ? "z-10" : "z-0 [backface-visibility:hidden]"
          )}
        >
